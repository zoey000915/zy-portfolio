...
import { LinkLabReveal } from './linklab-reveal';
import './linklab.css';
...
export default function LinkLabPage() {
  ...
  return <><SiteHeader /><main className="link-case"><LinkLabReveal />
    <section className="link-hero" data-link-reveal><div className="shell link-hero-grid">
